...
`session_transcript`: REQUIRED. A base64url JSON object that is an ephemeral public key generated by the Verifier for session encryption. The key is a bare key in JWK [RFC7517] format (not an X.509 certificate value).
